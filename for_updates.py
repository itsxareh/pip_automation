...
class BPIDataProcessor:
    def __init__(self, base_path=None):
        ...
        self.input_folder = os.path.join(self.pwd, "FOR_UPDATES")
        self.output_folder = os.path.join(self.pwd, "BPI_FOR_UPDATES")
    ...
    def _get_input_file(self):
        ...
        return os.path.join(self.input_folder, f"FOR UPDATE {current_date}.xlsx")

    def _get_output_file(self):
        current_date = datetime.datetime.now().strftime('%m%d%Y')
        return os.path.join(self.output_folder, f"BPI AUTO CURING FOR UPDATES {current_date}.xlsx")
